...
LLM_EMOTION_DIRECTIONS = {
    "normal": "Answer basic questions in an eerie, disturbed ,terrifying ,grimm off-center way  .",
    "supportive": "Answer supportively in a grimm way , macabre way , off center , but also be supportive as well .",
    "flirting": "Make that conversation feel intimate in a very disturbing horrifying way.",
